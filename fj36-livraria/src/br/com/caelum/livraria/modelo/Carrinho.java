...
public class Carrinho implements Serializable {
	...
	private void atualizarQuantidadeDisponivelDoItemCompra(final ItemEstoque itemEstoque) {
		...
		item.setQuantidadeNoEstoque(itemEstoque.getQtd());
	}
	...
	public void verificarDisponibilidadeDosItensComSoap() {
		...
		for (final ItemEstoque itemEstoque : itensNoEstoque){
			this.atualizarQuantidadeDisponivelDoItemCompra(itemEstoque);
		}
	}

//	public void verificarDisponibilidadeDosItensComRMI() {
//		// TODO Auto-generated method stub
//		EstoqueRMI estoqueRMI;
//		try {
//			estoqueRMI = (EstoqueRMI) Naming.lookup("rmi://localhost:1099/estoque");
//			
//			for (ItemCompra itemCompra : itensDeCompra) {
//				if(itemCompra.isImpresso()){
//					System.out.println("Verificando estoque do livro "+ itemCompra.getCodigo() );
//					ItemEstoque ie = estoqueRMI.getItemEstoque(itemCompra.getCodigo());
//					if(ie != null)
//						itemCompra.setQuantidadeNoEstoque(ie.getQtd());
//				}
//				
//			}
